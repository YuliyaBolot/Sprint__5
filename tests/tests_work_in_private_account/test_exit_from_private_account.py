...
driver.find_element(By.XPATH, ".//ul[@class = 'Account_list__3KQQf mb-20']//button[@class = 'Account_button__14Yp3 text text_type_main-medium text_color_inactive']").click()
